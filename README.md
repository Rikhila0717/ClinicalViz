...
- **Validation**: 86 unit tests + 3 integration tests (97% code coverage). SonarCloud dashboard monitors code smells, duplication, and maintainability (1 issue involving cognitive complexity overload - this involves some code refactoring, I don't think I will be able to finish it by the deadline). Manual end-to-end testing with diverse queries across all visualization types. Deployed as a Docker image, pulled on a different system and performed integration tests.
